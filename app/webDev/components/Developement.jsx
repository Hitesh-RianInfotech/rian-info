...
const Developement = () => {
  return (
    <div className="flex flex-col bg-[url('/images/orange.png')]  bg-white bg-cover bg-center lg:flex-row items-center justify-between lg:h-screen pt-32  py-16 px-6 md:px-16">
      {/* Left Content */}
