...
const Profi = () => {
  return (
    <div className="flex flex-col bg-[url('/images/casebg.png')] bg-white bg-cover bg-center lg:flex-row items-center justify-between lg:min-h-screen pt-32 py-12 px-4 sm:px-6 lg:pl-16 md:px-16 lg:px-0 overflow-hidden">
      {/* Left Content */}
      ...
      <div className="relative w-[90vw]  lg:w-3/5 h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] flex justify-center items-center">
        {/* Left Phone */}
        <div className="absolute hover:scale-110 hover:z-50 duration-300 w-32 sm:w-48 md:w-52 lg:w-60 transform -rotate-12 z-0 left-1/2 translate-x-[-120%] sm:-translate-x-10 sm:left-[15%] md:left-[20%] cursor-pointer lg:left-[15%]">
        ...
        {/* Center Phone */}
        <div className="relative hover:scale-110 hover:z-50 duration-300 w-36 sm:w-52 md:w-56 lg:w-64 z-10 cursor-pointer transform -translate-y-3">
          <div className="relative w-full" style={{ paddingTop: "200%" }}>
            {/* Custom Mobile Frame */}
            <div className="absolute inset-0 rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] shadow-xl border-4 sm:border-8 border-black overflow-hidden">
              {/* Notch */}
        ...
        {/* Right Phone */}
        <div className="absolute hover:scale-110 hover:z-50 duration-300 w-32 sm:w-48 md:w-52 lg:w-60 transform rotate-12 z-0 right-1/2 translate-x-[120%] sm:translate-x-10 sm:right-[15%] md:right-[20%] cursor-pointer lg:right-[15%]">
          <div className="relative w-full" style={{ paddingTop: "200%" }}>
            {/* Custom Mobile Frame */}
            <div className="absolute inset-0 rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] shadow-xl border-4 sm:border-8 border-black overflow-hidden">
              {/* Notch */}
