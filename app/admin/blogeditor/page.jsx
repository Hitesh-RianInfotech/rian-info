...
// // Simple toolbar button with tooltips
...
// // MenuBar includes all formatting controls
...
//   // Configure the editor with required extensions:
//   // • StarterKit (includes paragraph, bullet/ordered lists, blockquote, etc.)
//   // • Heading (configured for H1 and H2; you can add more levels if needed)
//   // • Underline, Link, and Image
...
//       }),
//       Heading.configure({
//         levels: [1, 2], // Only H1 and H2 for simplicity
//       }),
//       Underline,
//       Link.configure({
//         openOnClick: false,
...
//     }
//     setIsSaving(true);
//     // Simulate API call (replace with your actual publish logic)
//     setTimeout(() => {
...
//   return (
//     <>
//       <div className="p-6 max-w-3xl pt-20 mx-auto">
...
//           className="w-full p-2 mb-4 font-bold text-3xl border rounded"
//         />
...
//       {/* Global styles to ensure headings, paragraphs, and lists render properly */}
//       <style jsx global>{`
//         /* Headings will be larger and bolder */
//         h1 {
//           font-size: 2.5rem;
//           font-weight: 700;
//           margin: 1rem 0;
...
//           margin: 0.75rem 0;
//         }
//         /* Paragraphs as standard body text */
//         p {
//           font-size: 1rem;
//           font-weight: 400;
//           margin: 0.5rem 0;
//         }
//         /* Lists with standard bullet styling */
//         ul {
